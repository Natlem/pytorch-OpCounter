...
class ResNetAdapter(object):
    ...
    def type_2_str(self, param_type):
        if param_type == ParameterType.CNN_WEIGHTS:
            ...
            return BN_STR
        elif param_type == ParameterType.DOWNSAMPLE_WEIGHTS or param_type == ParameterType.DOWNSAMPLE_BN_W or param_type == ParameterType.DOWNSAMPLE_BN_B:
